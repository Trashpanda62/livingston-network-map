...
- PASS — listing edges match source rows · 86 lists edges vs {'outdoors': 40, 'visit': 35, 'printers': 11} = 86
- PASS — node total = listed + our properties · 95 = 83 + 12
...
- PASS — at least 20 nodes geo-placed on the city map · 75 geo-placed (23 exact, 23 approx)
...
- PASS — total payload under 8 MB · 7245 KB
